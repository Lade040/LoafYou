...
?>
    ...
    <?php
         if (!empty($_SESSION['cart'])) {
          ...
          echo "<div class='mt-5 mb-5'><a href='checkout.php' class='btn btn-lg   mb-2 col-12 proimage btn-outline-secondary'>Proceed to Checkout</a></div></div>";
          
      } else {
          echo "<div><h4>Your cart is empty.</h4></div>";
      }
