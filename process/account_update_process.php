...
if($_POST){
    ...
    // for radio button
        ...
        $cust1= new Customer();
        $update=$cust1->update_customer_details($cust_firstname,$cust_lastname,$cust_phone,$cust_email,$cust_gender,$cust_dob,$hashed_password,$cust_address, $cust_state,$cust_lga,$cust_id);

        if($update){
            $_SESSION["feedback"]="Account Updated Successfully";
           header("location:../account.php");
        }else{
            $_SESSION["feedback"]="Account Update Failed";
            header("location:../account.php");
        }
